        ...
        if(place === true){
            ...
            .then((response) => {
                   request = response.data.results.map(element => {
                       return `https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/api/place/details/json?place_id=${element.place_id}&key=AIzaSyDCQtJew09cPDkZ2qksjT-rIhelYI1rNvY`
                    });
